...
def main(bgtext):
    ...
    parser.add_argument('--length', default=700, type=int, required=False, help='生成长度')
    ...
    parser.add_argument('--prefix', default='{}'.format(str(bgtext)), type=str, required=False, help='生成文章的开头')
    parser.add_argument('--no_wordpiece', action='store_true', help='不做word piece切词')
    parser.add_argument('--segment', action='store_true', help='中文以词为单位')
    parser.add_argument('--fast_pattern', action='store_true', help='采用更加快的方式生成文本')
    parser.add_argument('--save_samples', action='store_true', help='保存产生的样本')
    parser.add_argument('--save_samples_path', default='./sample/sample_save', type=str, required=False, help="保存样本的路径")
...
def GPT2Article(text):
    bgtext= text
    string=main(bgtext=bgtext)
    return string